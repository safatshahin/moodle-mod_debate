...
/**
 * Debate restore task that provides all the settings and steps to perform one complete restore of the activity.
 */
class restore_debate_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('DEBATEVIEWBYID', '/mod/debate/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('DEBATEINDEX', '/mod/debate/index.php?id=$1', 'course');
